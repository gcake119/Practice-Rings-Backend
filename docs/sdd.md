...
**Version:** 1.4.0  
**Last Updated:** 2025-12-12 03:30 GMT+8  
**Update Focus:** 新增單日 / 月檢視、手機 swipe
...
- **【Day 1 大改動】新增「卡片 + 月曆展開」設計**：
  ...
  - 點擊最近 7 天圈圈 → 開啟單日卡片
  - 單日卡片：
    - 顯示當日三圈圈同心圓與各模式 `當日分鐘數 / 目標分鐘數`。
    - 「前一天 / 後一天」導覽按鈕，限定在有紀錄的日期區間
  - 月檢視：
    - 在單日卡片點右上行事曆按鈕切換
...
- **預設視圖**：
  ...
  - 卡片標題：「最近 7 天練習進度」。
  - 可點擊卡片進入「單日卡片」模式。
  - 單日卡片為獨立 Modal，沿用 Doraemon 風格 UI

- **月曆展開視圖**：

  - 點擊單日卡片右上方切換按鈕後，轉換為月曆顯示。
  - 月檢視行為：
    - 桌機：點「上月 / 下月」按鈕切換
    - 手機：上下滑動切換月份（說明使用 touch 事件）
  - 行事曆格子：
...
const state = {
  ...
  currentViewDate: "", // 目前單日卡片所顯示的日期
  currentCalendarDate: new Date(), // 月檢視目前所在月份的基準日期
};
```
